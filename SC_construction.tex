...
En la figura \ref{fig:resumen_eis} se muestran espectros de impedancia para distintas muestras, siguiendo el procedimiento experimental, este es tomado inmediatamente después de realizada primera voltametría cíclica. \citep{Wang2009}.
