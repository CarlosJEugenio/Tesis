...
\section{Resultados}
Los resultados son presentados en una serie de gráficos para cada muestra de la tabla \ref{tab:electrodos_construidos} y para los sustratos sin material depositado. \ref{SCGraphs:CV_CRGO300517_9}
