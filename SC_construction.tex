...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% powder + pmma on Ni Foam. mass = 2.8 mg %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
	\centering
	\begin{subfigure}{\plotwidth}
	...
	\begin{subfigure}{0.3\textwidth}
		...
		\addplot table {./Data/CV_CRGO300517_3/raw/capacitance.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	...
	\begin{subfigure}{0.3\textwidth}
		...
		\addplot table {./Data/CV_CRGO300517_4/raw/capacitance.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\caption{powder + pmma on Ni Foam. mass = 2.8 mg}
\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}{0.3\textwidth}
		...
		\addplot table {./Data/CV_CRGO300517_5/raw/capacitance.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	...
	\begin{subfigure}{0.3\textwidth}
		...
		\addplot table {./Data/CV_CRGO300517_6/raw/capacitance.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\caption{Powder on Ni Foam. Mass = 0.9mg}
\end{figure}
