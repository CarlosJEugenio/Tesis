...
\begin{figure}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_3/raw/sample1.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_3/raw/sample2.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_3/raw/sample3.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_3/raw/sample4.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_3/raw/sample5.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\hfill
	\begin{subfigure}{\plotwidth}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_4/raw/sample1.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_4/raw/sample2.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_4/raw/sample3.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_4/raw/sample4.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_4/raw/sample5.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\hfill
	\begin{subfigure}{\plotwidth}
...
\begin{figure}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_5/raw/sample1.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_5/raw/sample2.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_5/raw/sample3.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_5/raw/sample4.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_5/raw/sample5.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\hfill
	\begin{subfigure}{\plotwidth}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_6/raw/sample1.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_6/raw/sample2.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_6/raw/sample3.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_6/raw/sample4.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_6/raw/sample5.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\hfill
	\begin{subfigure}{\plotwidth}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot[restrict x to domain=0:5, color=red] table [x expr=\thisrow{Time}-0, y expr=\thisrow{Voltage}] {./Data/CV_CRGO300517_5/raw/chargedischarge.txt};	
		\addplot[restrict x to domain=0:5, color=blue] table [x expr=\thisrow{Time}-1583.89233300000, y expr=\thisrow{Voltage}] {./Data/CV_CRGO300517_5/raw/chargedischarge.txt};
		%		\draw[black] decorate [decoration={zigzag}] {(axis cs:5,0) -- (axis cs:5,1)};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_7/raw/sample1.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_7/raw/sample2.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_7/raw/sample3.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_7/raw/sample4.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_7/raw/sample5.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\hfill
	\begin{subfigure}{\plotwidth}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_8/raw/sample1.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_8/raw/sample2.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_8/raw/sample3.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_8/raw/sample4.txt};
		\addplot table [x=Voltaje, y expr=\thisrow{Corriente}/0.0006 ] {./Data/CV_CRGO300517_8/raw/sample5.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\hfill
	\begin{subfigure}{\plotwidth}
	...
	\begin{subfigure}{\plotwidth}
		...
		\addplot[restrict x to domain=0:5, color=blue] table [x expr=\thisrow{Time}-1583.89233300000, y expr=\thisrow{Voltage}] {./Data/CV_CRGO300517_7/raw/chargedischarge.txt};
		%		\draw[black] decorate [decoration={zigzag}] {(axis cs:5,0) -- (axis cs:5,1)};
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}
