...
\begin{figure}
	...
	\begin{subfigure}{\plotwidth}
		\begin{tikzpicture}[scale=\plotscale,trim axis right,trim axis left]
			\begin{axis}[EISStyle]
				\addplot table [only marks, x=Zreal, y expr=\thisrow{Zimag}*-1] {./Data/CV_CRGO300517_11/raw/eisgalv.txt};	
			\end{axis}
		\end{tikzpicture}
	\end{subfigure}\\
	\begin{subfigure}{\plotwidth}
...
\begin{figure}
	...
	\begin{subfigure}{\plotwidth}
		\begin{tikzpicture}[scale=\plotscale,trim axis right,trim axis left]
		\begin{axis}[EISStyle]
		\addplot table [only marks, x=Zreal, y expr=\thisrow{Zimag}*-1] {./Data/CV_CRGO300517_13/raw/eisgalv.txt};	
		\end{axis}
		\end{tikzpicture}
	\end{subfigure}\\
	\begin{subfigure}{\plotwidth}
