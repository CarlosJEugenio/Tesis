\chapter{\label{cap:Supercondensadores}Supercondensadores}
...
\section{\label{cap:Supercondensadores:sec:condensador ideal}El condensador ideal\index{condensador ideal}}
...
\section{\label{cap:Supercondensadores:sec:condensador real}El condensador real\index{condensador real}}
...
\subsubsection{Resistencia en serie equivalente (ESR)}
Las imperfecciones en la construcción de los electrodos, y la naturaleza de los materiales utilizados (e.g. resistencia no cero), disipan energía en la carga y descarga como si se tratase de una resistencia en serie al condensador, esto se ve reflejado por una caída de voltaje en los terminales del dispositivo (figura \ref{fig:plot:charge-discharge_esr}), y disminuye la eficiencia de éste.
...
\subsubsection{Corriente de fuga (\emph{leakage current})}

\section{\label{cap:Supercondensadores:sec:supercondensador}¿Qué hace a un supercondensador?}
