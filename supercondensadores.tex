...
\subsection{Circuito equivalente\index{circuito equivalente}}
...
\subsection{Resistencia en serie equivalente (ESR)\index{resistencia en serie equivalente}}
...
\subsection{Corriente de fuga (\emph{leakage current})\index{corriente de fuga}}
Entre los electrodos del condensador fluye una corriente no deseada cuando existe una diferencia de potencial entre los electrodos (cuando el condensador está cargado), esta corriente descarga al condensador incluso si está desconectado.

\section{¿Qué hace a un supercondensador super?\index{supercondensador}}
...
\subsection{Pseudocapacitancia\index{pseudocapacitancia}}
