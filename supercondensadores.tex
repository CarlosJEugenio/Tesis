...
\begin{figure}[h!]
	...
	\begin{subfigure}{\textwidth}
		...
		\caption[Simulación de circuito equivalente]{Espectro electroquímico de impedancia simulados para los circuitos equivalentes \subref{fig:eq_classic} y \subref{fig:eq_randles}. Obtenido de EIS Spectrum Analyser\footnotemark.}
	\end{subfigure}
