...
En la figura \ref{fig:raman} se muestra el espectro Raman del óxido de grafeno y óxido reducido de grafeno sintetizados \citep{Abdolhosseinzadeh2015,}
\begin{figure}
	\centering
	\begin{tikzpicture}[]
		\begin{axis}[
		...
		width = \textwidth,
		ylabel={Intensidad [u.a.]},
		xlabel={Número de onda$\mathrm{cm^{-1}}$},
