	...
	\begin{frame}[fragile]{Caracterización de supercondensadores}
		\begin{columns}
			\begin{column}{0.5\textwidth}
				...
				\begin{itemize}[<+(1)->]
					\item Barrido en frecuencia de una señal sinusoidal.
					\item Medición de la impedancia en función de la frecuencia.
					\item Representación en un gráfico de Nyquist.
				\end{itemize}
			\end{column}
			\begin{column}{0.5\textwidth}
				\begin{figure}
